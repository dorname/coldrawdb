...
## 变更提案
- 提案名称：implement-unified-prototype-spec-parity
- 提案目录：logos/changes/implement-unified-prototype-spec-parity/
...
### 1. deltas/test/core-KB-shortcut-test-cases.md

- Delta 文件：`logos/changes/implement-unified-prototype-spec-parity/deltas/test/core-KB-shortcut-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 2. deltas/test/core-PC-import-export-test-cases.md

- Delta 文件：`logos/changes/implement-unified-prototype-spec-parity/deltas/test/core-PC-import-export-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 3. deltas/test/core-PU-unified-prototype-test-cases.md

- Delta 文件：`logos/changes/implement-unified-prototype-spec-parity/deltas/test/core-PU-unified-prototype-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 4. deltas/test/core-S01-test-cases.md

- Delta 文件：`logos/changes/implement-unified-prototype-spec-parity/deltas/test/core-S01-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 5. deltas/test/core-S02-test-cases.md

- Delta 文件：`logos/changes/implement-unified-prototype-spec-parity/deltas/test/core-S02-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 6. deltas/test/core-S03-test-cases.md

- Delta 文件：`logos/changes/implement-unified-prototype-spec-parity/deltas/test/core-S03-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 7. deltas/test/core-S04-test-cases.md

- Delta 文件：`logos/changes/implement-unified-prototype-spec-parity/deltas/test/core-S04-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 8. deltas/test/core-S05-test-cases.md

- Delta 文件：`logos/changes/implement-unified-prototype-spec-parity/deltas/test/core-S05-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 9. deltas/test/core-V2-production-frontend-test-cases.md

- Delta 文件：`logos/changes/implement-unified-prototype-spec-parity/deltas/test/core-V2-production-frontend-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档
...
8. 所有变更合并完成后，自动执行 git commit（告知用户，无需确认）：
   git add -A && git commit -m "docs(implement-unified-prototype-spec-parity): merge spec deltas"
   然后提示用户：按更新后的规格实现代码，代码完成后运行 `openlogos verify` 验收，验收通过后明确授权执行 `openlogos archive implement-unified-prototype-spec-parity`。
