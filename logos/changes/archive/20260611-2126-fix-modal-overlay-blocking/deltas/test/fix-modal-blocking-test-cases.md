# ADDED — ModalRoot 条件渲染 + canvas testid 修复测试用例规格
...
**对应 spec 测试 ID**：
- `core-05-top-menu-modals.md` §9 — UT-FIX-01
- `core-01-editor-canvas.md` §5.5 — UT-FIX-02
- 本文件 §3 — ST-FIX-01
...
- `core-05-top-menu-modals.md` §4.1（遮罩行为）+ §9（UT-FIX-01 索引）
- `core-01-editor-canvas.md` §5.1（testid 约束）+ §5.5（UT-FIX-02 索引）
