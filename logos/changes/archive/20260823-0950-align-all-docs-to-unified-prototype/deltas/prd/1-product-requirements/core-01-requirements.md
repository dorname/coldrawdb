# Delta — core-01-requirements.md（修改）

> module: core | proposal: align-all-docs-to-unified-prototype

## ADDED — 统一原型对齐补充：V1 产品需求（事实锚点）

# 产品需求（事实锚点：V1 + V2 工作空间）
...
## MODIFIED — 4. 非功能性需求（Non-Functional Requirements）
...
## MODIFIED — 5.3 "不做"清单（Out of Scope）
