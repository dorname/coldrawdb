...
## 变更提案
- 提案名称：wire-frontend-collab-ws
- 提案目录：logos/changes/wire-frontend-collab-ws/
...
### 1. deltas/prd/3-technical-plan/2-scenario-implementation/core-S05-ot-collab.md

- Delta 文件：`logos/changes/wire-frontend-collab-ws/deltas/prd/3-technical-plan/2-scenario-implementation/core-S05-ot-collab.md`
- 目标目录：`logos/resources/prd/3-technical-plan/2-scenario-implementation/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 2. deltas/test/core-S05-test-cases.md

- Delta 文件：`logos/changes/wire-frontend-collab-ws/deltas/test/core-S05-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 3. deltas/test/core-V2-production-frontend-test-cases.md

- Delta 文件：`logos/changes/wire-frontend-collab-ws/deltas/test/core-V2-production-frontend-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档
...
8. 所有变更合并完成后，自动执行 git commit（告知用户，无需确认）：
   git add -A && git commit -m "docs(wire-frontend-collab-ws): merge spec deltas"
   然后提示用户：按更新后的规格实现代码，代码完成后运行 `openlogos verify` 验收，验收通过后明确授权执行 `openlogos archive wire-frontend-collab-ws`。
