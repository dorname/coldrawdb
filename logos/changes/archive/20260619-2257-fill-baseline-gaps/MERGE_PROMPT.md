...
## 变更提案
- 提案名称：fill-baseline-gaps
- 提案目录：logos/changes/fill-baseline-gaps/
...
- Delta 文件：`logos/changes/fill-baseline-gaps/deltas/prd/1-product-requirements/core-01-requirements.md`
- 目标目录：`logos/resources/prd/1-product-requirements/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 2. deltas/prd/1-product-requirements/core-02-product-vision.md

- Delta 文件：`logos/changes/fill-baseline-gaps/deltas/prd/1-product-requirements/core-02-product-vision.md`
- 目标目录：`logos/resources/prd/1-product-requirements/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 3. deltas/prd/1-product-requirements/core-03-pain-points.md

- Delta 文件：`logos/changes/fill-baseline-gaps/deltas/prd/1-product-requirements/core-03-pain-points.md`
- 目标目录：`logos/resources/prd/1-product-requirements/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 4. deltas/prd/1-product-requirements/core-04-scenario-detail.md

- Delta 文件：`logos/changes/fill-baseline-gaps/deltas/prd/1-product-requirements/core-04-scenario-detail.md`
- 目标目录：`logos/resources/prd/1-product-requirements/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 5. deltas/prd/3-technical-plan/1-architecture/core-01-architecture-overview.md

- Delta 文件：`logos/changes/fill-baseline-gaps/deltas/prd/3-technical-plan/1-architecture/core-01-architecture-overview.md`
...
8. 所有变更合并完成后，自动执行 git commit（告知用户，无需确认）：
   git add -A && git commit -m "docs(fill-baseline-gaps): merge spec deltas"
   然后提示用户：按更新后的规格实现代码，代码完成后运行 `openlogos verify` 验收，验收通过后明确授权执行 `openlogos archive fill-baseline-gaps`。
